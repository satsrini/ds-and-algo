...
import com.algods.graph.shortestpath.acyclic.DepthFirstOrderEdgeWeighted;
import com.algods.graph.shortestpath.DirectedEdge;


public class TestDepthFirstOrderEdgeWeighted
{
	...
	public void setUp()
	{
        ...
        public void testDepthFirstOrder()
        {
            DepthFirstOrderEdgeWeighted depthFirstOrderEdgeWeighted
                                       = new DepthFirstOrderEdgeWeighted(g1);

            System.out.println("\n\n");
            System.out.println("PreOrder: ");

            for(int k:depthFirstOrderEdgeWeighted.pre())
            {
                System.out.print(k + " ");
            }
            ...
            for(int k:depthFirstOrderEdgeWeighted.post())
            {
                System.out.print(k + " ");
            }
            ...
            for(int k:depthFirstOrderEdgeWeighted.reversePost())
            {
                System.out.print(k + " ");
            }
